	...
	try{
		...
		if(isset($_SESSION["tipo_cuenta_filtros"]) && $_SESSION["tipo_cuenta_filtros"] > 0){
			...
			while($fila = $resultado->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT)){
				...
				$linea_tabla[$index_t] = "<tr class='renglon_historial'><td class='renglon'>".$fila[0]."</td><td class='renglon'>".$fila[1]."</td><td class='renglon'>".$fila[2]."</td><td class='renglon'>".$fila[3]."</td><td class='renglon'>$ ".$formato_cantidad."</td><td class='renglon'>".$fila[5]."</td><td class='renglon'>".$fila[6]."</td></tr>";
				$index_t++;
			}
